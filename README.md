...
run('TestsValidacion.m')      % catorce tests del generador, termina con error si alguno falla
```
...
| Área | Estado |
|---|---|
| Generador de geometría (loop, hélice, over-banked turn, dive loop) | Implementado y con 14 tests pasando (ver [`documentacion_generador_elementos.md` §11](documentacion_generador_elementos.md#11-tests-de-validación)) |
