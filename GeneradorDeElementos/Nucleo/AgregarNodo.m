...
%AGREGARNODO Vuelca un punto evaluado en las tablas del registro.
    ...
    Registro.CurvaturaArribaCarro(Indice)    = Punto.CurvaturaArribaCarro;
    Registro.CurvaturaLateralCarro(Indice)   = Punto.CurvaturaLateralCarro;
    ...
    Registro.VelocidadCentroDeMasa(Indice)   = Punto.VelocidadCentroDeMasa;
    Registro.FactorVelocidadHeartline(Indice) = Punto.FactorVelocidadHeartline;
    ...
    Registro.GArribaVerificacion(Indice)     = Punto.GArribaVerificacion;
    Registro.GLateralVerificacion(Indice)    = Punto.GLateralVerificacion;
