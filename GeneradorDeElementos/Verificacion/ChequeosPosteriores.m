...
%   normativos dependen del recorrido construido.
    ...
    % RadioLoop sigue siendo el que fija lambda_loop y con el el presupuesto de
    ...
    % equivocada y hay que corregir RadioLoop y regenerar.
    RazonDeRadios = RadioMinimo / Parametros.RadioLoop;
    Criterios = AgregarCriterio(Criterios, 'Radio alcanzado coherente con el nominal', 'MayorOIgual', ...
        ...
        sprintf(['Radio nominal %.4f m contra alcanzado %.4f m. RadioLoop es la longitud ' ...
                 'caracteristica de Froude: fija lambda_loop, el presupuesto de onset y la ' ...
                 'conversion de duraciones.'], Parametros.RadioLoop, RadioMinimo));

    Criterios = AgregarCriterio(Criterios, 'Altura del loop', 'MenorOIgual', ...
        max(AlturaRelativa), Parametros.AlturaMaximaLoop, 'm', ...
