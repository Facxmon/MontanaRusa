...
const TOKENS = {
  ...
  serie2: '--serie-2',
  serie3: '--serie-3',
  serieComparacion1: '--serie-comparacion-1',
  serieComparacion2: '--serie-comparacion-2',
  serieComparacion3: '--serie-comparacion-3',
  ...
  escenaFondoArriba: '--escena-fondo-arriba',
  escenaRotulo: '--escena-rotulo',
  escenaCaja: '--escena-caja',
  escenaCajaFuera: '--escena-caja-fuera',
  escenaProyeccion: '--escena-proyeccion',
  escenaEjeX: '--escena-eje-x',
  escenaEjeY: '--escena-eje-y',
  escenaEjeZ: '--escena-eje-z',
